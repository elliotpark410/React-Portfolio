let resumeData = {
  ...
  roleDescription:
    'I am here to infiltrate earthling technology with Full Stack Web Development.',
  socialLinks: [
    {
      name: 'linkedin',
  ...
  work: [
    {
      ...
      Achievements: `
        ...
        • Develop hundreds of unit tests, integration tests, and end-to-end tests to verify the functionality of back-end processing, database interactions, and business logic
        ...
        • Improve customer experience by integrating the server with third-party APIs like Fireblocks, DurianPay, Solana, ICP, and Slack
  ...
  skillsDescription:
    'Git, Bash, HTML, CSS, React, JavaScript, Jest, TypeScript, SQL, Node, Express, Prisma, Sequelize, Mongoose, MySQL, MongoDB, Postman, Insomnia, Docker, Linux, Sentry, CI/CD',
  portfolio: [
    {
      name: 'Code Quiz',
      description:
    ...
    },
    {
      name: 'Text Editor',
      description:
        'A text editor app that runs in the browser and meets the Progressive Web App criteria.',
      imgurl: 'images/portfolio/text-editor.png',
      imgrepo: 'https://github.com/elliotpark410/Text-Editor',
      imglink:
        'https://drive.google.com/file/d/1JcmvHDmYU6WjGITv-FaK7d9HGSF34AQG/view',
    },
  ],
};
